...
namespace JavaChoose
{
    ...
    {
        public string VersionName { get; set; }   // 如 "jdk-8", "jre-8"
        public string InstallPath { get; set; }   // 安装根目录
        public int MajorVersion { get; set; }     // 主版本号数字
        public bool IsJre { get; set; }           // 是否为 JRE

        // 格式化后的 number 字段：JRE 前加 "00"
